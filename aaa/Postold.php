 ...
 *          "get"={"path"="/ressources/affi/search/post/allfind/","normalization_context"={"groups"={"postation_post:read"}} }},
 *     itemOperations={
 *          "get"={"path"="ressources/affi/search/post/find/{id}","normalization_context"={"groups"={"postation_post:read","postation_post_full:read"}} }},
 *     attributes={"pagination_items_per_page"=2,"order"={"createAt":"DESC"}
 *     }
 *)
