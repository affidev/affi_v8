    ...
    let uploadpreview = function(f, art,pw) {
        ...
        $.resizor({l: 600, h: 600, f: oFile, p: false}).then((thetumb) => {
            f.value = "";
                ...
                document.getElementById("carte_base64").value = thetumb.src

        })
    }


    document.getElementById("carte_pict_file").addEventListener("change",function(e) {
        uploadpreview(this,'carte_pict_file',"uploadpreview");
    });
