        ...
        okgolocate(){
                ...
                if (localitate.l_thisliselected) {
                    ...
                    if(this.l_class ==="cargo") {
                        ...
                        window.location.href = "/locate/?lon=" + localitate.l_thisliselected.centre.coordinates[0] + "&&lat=" + localitate.l_thisliselected.centre.coordinates[1] + "&&nom=" + localitate.l_thisliselected.nom + "&&code=" + localitate.l_thisliselected.codesPostaux[0]
                    ...
                    if(this.l_class ==="customer") {
                       ...
                       // routetest = Routing.generate('new_locate', {city: city.text(), code: code.text()}, true);
                        //window.location.href = Routing.generate('locate_affi', {lon: localitate.l_thisliselected.centre.coordinates[0], lat:localitate.l_thisliselected.centre.coordinates[1]});
                        window.location.href = "/customer/profil/change-locate-customer/?lon=" + localitate.l_thisliselected.centre.coordinates[0] + "&&lat=" + localitate.l_thisliselected.centre.coordinates[1] + "&&nom=" + localitate.l_thisliselected.nom + "&&code=" + localitate.l_thisliselected.codesPostaux[0]
                    }
                    if(this.l_class ==="init") {
                        ...
                        window.location.href = "/customer/initlocalizer/init-locate-customer/?lon=" + localitate.l_thisliselected.centre.coordinates[0] + "&&lat=" + localitate.l_thisliselected.centre.coordinates[1] //+ "&&nom=" + localitate.l_thisliselected.nom + "&&code=" + localitate.l_thisliselected.codesPostaux[0]
                    }
