...
export function SearchLocate (props) {
    ...
    function okgolocate(localitate){
        if (localitate) {
            if(l_class ==="cargo") {
                window.location.href = "/locate/?lon=" + localitate.centre.coordinates[0] + "&&lat=" + localitate.centre.coordinates[1] + "&&nom=" + localitate.nom + "&&code=" + localitate.codesPostaux[0]
            }
            if(l_class ==="customer") {
                window.location.href = "/customer/profil/change-locate-customer/?lon=" + localitate.centre.coordinates[0] + "&&lat=" + localitate.centre.coordinates[1] + "&&nom=" + localitate.nom + "&&code=" + localitate.codesPostaux[0]
            }
            if(l_class ==="init") {
                window.location.href = "/customer/initlocalizer/init-locate-customer/?lon=" + localitate.centre.coordinates[0] + "&&lat=" + localitate.centre.coordinates[1] //+ "&&nom=" + localitate.nom + "&&code=" + localitate.codesPostaux[0]
            }
        }
    }
