 ...
 * @ORM\Entity(repositoryClass="App\Repository\Entity\MsgsRepository")
 */
class Msgs
{
    /**
    ...
    /**
     *
     * @ORM\ManyToOne(targetEntity="\App\Entity\LogMessages\MsgWebsite", inversedBy="msgs")
     * @ORM\JoinColumn(nullable=true)
     */
    private $msgwebsite;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\LogMessages\Tbmsgs", mappedBy="idmessage", cascade={"persist", "remove"})
     */
    private $tabreaders;
    ...
    public function getMsgwebsite(): ?MsgWebsite
    {
        return $this->msgwebsite;
    }

    public function setMsgwebsite(?MsgWebsite $msgwebsite): self
    {
