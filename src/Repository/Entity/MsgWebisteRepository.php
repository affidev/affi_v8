...
/**
 * @method MsgWebsite|null find($id, $lockMode = null, $lockVersion = null)
 * @method MsgWebsite|null findOneBy(array $criteria, array $orderBy = null)
 * @method MsgWebsite[]    findAll()
 * @method MsgWebsite[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class MsgWebisteRepository extends ServiceEntityRepository
{
    ...
    {
        parent::__construct($registry, MsgWebsite::class);
    }
