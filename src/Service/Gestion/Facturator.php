...
class Facturator
{
     ...
     */
    public function newFacture(Wborders $order,DispatchSpaceWeb $dispatch): Dompdf
    {
    ...
    public function replaceFacture($order,DispatchSpaceWeb $dispatch, $facture): Dompdf
    {
    ...
    public function newFactureCustomer(Orders $order): Dompdf
    {
        ...
        $dispatch=$customer->getDispatchspace();
    ...
    public function replaceFactureCustomer($order,DispatchSpaceWeb $dispatch, $facture): Dompdf
    {
        $dompdf=$this->getFacture->miseAjPdffacture($facture, $order, $dispatch);
        $this->em->persist($facture);
        $this->em->flush();
