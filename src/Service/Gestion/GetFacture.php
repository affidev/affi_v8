...
class GetFacture extends AbstractController
{
     ...
     * @return Dompdf
     */
    public function newpdffactureCustomer(FacturesCustomer $facture, Orders $order, DispatchSpaceWeb $dispatch): Dompdf
    {
        dump($order);
        $pdfOptions = new Options();
        $pdfOptions->set('defaultFont', 'Arial');
     ...
     * @return Dompdf
     */
    public function miseAjPdffactureCustomer(FacturesCustomer $facture, Orders $order, DispatchSpaceWeb $dispatch): Dompdf
    {
        $publicDirectory =  __DIR__.'/../../../public/wb-v5/gest/'.$this->getParameter('path_facture').'/admin-/pdf';
        $pdf=$facture->getPdfacture();
        $oldpdfFilepath =  $publicDirectory.$pdf;
     ...
     * @return Dompdf
     */
    public function showpdffactureCustomer(FacturesCustomer $facture, Orders $order, DispatchSpaceWeb $dispatch): Dompdf
    {
        $pdfOptions = new Options();
        $pdfOptions->set('defaultFont', 'Arial');
        $pdfOptions->set('isRemoteEnabled', true);
     ...
     * @return Dompdf
     */
    public function newpdfcmdCustomer(Orders $order, DispatchSpaceWeb $dispatch): Dompdf
    {
        $pdfOptions = new Options();
        $pdfOptions->set('defaultFont', 'Arial');
        $pdfOptions->set('isRemoteEnabled', true);
