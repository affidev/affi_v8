...
class WebsiteMessageor
{
     ...
     */
    public function newMessageBoard($data, $website, $client, $dispatch=null): MsgWebsite
    {
        $contact=null;
    ...
    /**
     */
    public function addConvers($data, MsgWebsite $convers, DispatchSpaceWeb $dispatch): Msgs
    {
        $content = Tools::cleanspecialcaractere($data['comment']);
     ...
     * @return array
     */
    public function sortmesswebsite($pagination, Spwsite $pw, $dispatch): array
    {
