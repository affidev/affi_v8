...
class MailatorWebsite
{
    ...
    public function __construct(EntityManagerInterface $entityManager, Canonicalizer $emailCanonicalizer,UrlGeneratorInterface $router, Security $security, ContactMailer $contactMailer, Sender $sender)
    {
