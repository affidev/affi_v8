...
class DefaultModules
{
    ...
    const TAB_MODULES_INFO=array(
        ...
        'module_found'=>['link'=>'module_found','name'=>"module de gestion de menu en ligne",'title'=>"Proposez vos menus en ligne",'desc'=>"Votre gestionnaire de réservation. Astuce : utilisez le lien dans vos courriers électroniques, site web...et gérez vos réservations depuis votre Space Info",'price'=>"10,00€"],
