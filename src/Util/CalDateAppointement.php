...
class CalDateAppointement
{
     ...
     * @return Appointments
     */
    public function daysParutions($listdates, $entity): Appointments
    {
        ...
        $appointment->setLocalisation($entity->getWebsite()->getLocality());
    ...
    public function alongDaysFormule($website, $form, Appointments $appointment)
    {
        ...
        $appointment->setLocalisation($website->getLocality());
        $appointment->setStatut(true);
        $appointment->setConfirmed(true);
        return $appointment;
    }
    ...
    public function alongDayEvent($partner, $start, $end, Appointments $appointment): Appointments
    {
        ...
        $appointment->setStarttime($start);
        $appointment->setEndtime($end);
        $appointment->setLocalisation($partner->getLocality());
        $appointment->setStatut(true);
        $appointment->setConfirmed(true);
        return $appointment;
    }
     ...
     * @return Appointments
     */
    public function initAppointEvent($gps, $tabdate,$dateselect,$now,Appointments $appointment): Appointments
    {
        $appointment->setTypeAppointment(4);
        ...
        $appointment->setStatut(true);
        $appointment->setConfirmed(true);
        $adtabdate=new Tabdate();
        $adtabdate->setTabdatejso($dateselect);
        $adtabdate->setTabdatestr($now);
        $appointment->setTabdate($adtabdate);
        return $appointment;
    }
