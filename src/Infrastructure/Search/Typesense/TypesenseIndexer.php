...
class TypesenseIndexer implements IndexerInterface
{
    ...
    {
        try {
            $this->client->patch("collections/website/documents/{$data['id']}", $data);
            ...
            if (Response::HTTP_NOT_FOUND === $exception->status && 'Not Found' === $exception->message) {
                ...
                $this->client->post('collections/website/documents', $data);
    ...
    {
        $this->client->delete("collections/website/documents/$id");
    }

    public function clean(): void
    {
        try {
            $this->client->delete('collections/website');
